...
# -----------------------------------------------------------------------------
# multi_agent-SPL MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.Multi_Agent_SPL = CN()
_C.TASK.Multi_Agent_SPL.TYPE = "MultiAgentSPL"
_C.TASK.Multi_Agent_SPL.SUCCESS_DISTANCE = 0.2

# multi_agent-multi_goals MEASUREMENT
# -----------------------------------------------------------------------------
_C.TASK.Multi_Agent_Multi_Goals = CN()
_C.TASK.Multi_Agent_Multi_Goals.TYPE = "MultiAgentMultiGoals"
_C.TASK.Multi_Agent_Multi_Goals.SUCCESS_DISTANCE = 0.2
# -----------------------------------------------------------------------------
...
# _C.SIMULATOR.AGENTS = ["AGENT_0", "AGENT_1", "AGENT_2", "AGENT_3", "AGENT_4"]
...
# _C.SIMULATOR.AGENT_2 = CN()
# _C.SIMULATOR.AGENT_2.HEIGHT = 1.5
# _C.SIMULATOR.AGENT_2.RADIUS = 0.1
# _C.SIMULATOR.AGENT_2.SENSORS = ["RGB_SENSOR"]
# _C.SIMULATOR.AGENT_2.IS_SET_START_STATE = False
# _C.SIMULATOR.AGENT_2.START_POSITION = [1, 1, 0]
# _C.SIMULATOR.AGENT_2.START_ROTATION = [0, 0, 0, 1]
# _C.SIMULATOR.AGENT_3 = CN()
# _C.SIMULATOR.AGENT_3.HEIGHT = 1.5
# _C.SIMULATOR.AGENT_3.RADIUS = 0.1
# _C.SIMULATOR.AGENT_3.SENSORS = ["RGB_SENSOR"]
# _C.SIMULATOR.AGENT_3.IS_SET_START_STATE = False
# _C.SIMULATOR.AGENT_3.START_POSITION = [1, 1, 0]
# _C.SIMULATOR.AGENT_3.START_ROTATION = [0, 0, 0, 1]
# _C.SIMULATOR.AGENT_4 = CN()
# _C.SIMULATOR.AGENT_4.HEIGHT = 1.5
# _C.SIMULATOR.AGENT_4.RADIUS = 0.1
# _C.SIMULATOR.AGENT_4.SENSORS = ["RGB_SENSOR"]
# _C.SIMULATOR.AGENT_4.IS_SET_START_STATE = False
# _C.SIMULATOR.AGENT_4.START_POSITION = [1, 1, 0]
# _C.SIMULATOR.AGENT_4.START_ROTATION = [0, 0, 0, 1]
# -----------------------------------------------------------------------------
