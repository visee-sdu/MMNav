...
class Env:
    ...
    def __init__(
        ...
        if self._dataset:
            ...
            self._config.SIMULATOR.SCENE = self.current_episode.scene_id  # hm3d/val/00877-4ok3usBNeis/4ok3usBNeis.basis.glb
            ...
            print('Number of episodes in dataset: ', self.number_of_episodes)
        else:
